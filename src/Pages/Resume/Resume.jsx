    ...
    <section>
      ...
      <div className="timeline">
        ...
        <ol className="timeline-list">
          <TimeLineItem
            category="Bachelor of Computer Science - B.Sc"
            title="Jairam Arts and Science College, Salem"
            date="2021 - 2024"
          ...
          <TimeLineItem
            ...
            title="Sri Sakthi Vikaas Metric Higher Secondary School, Belur"
            date="2018 - 2019"
